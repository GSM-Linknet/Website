...
import { Trash2, RotateCcw, RefreshCw, Download } from "lucide-react";
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center gap-2 self-start md:self-auto">
          <Button
            ...
            variant="outline"
            className="border-emerald-300 text-emerald-700 bg-emerald-50 hover:bg-emerald-100 hover:border-emerald-400 gap-2 h-9"
          >
