    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                month_grid: "w-full h-full border-collapse",
                weekdays: "grid grid-cols-7 mb-2",
                weekday: "text-slate-400 font-bold text-xs uppercase tracking-wider text-center py-2",
                week: "grid grid-cols-7 w-full mt-2 gap-2 flex-1",
                day: "h-auto w-full aspect-square text-center p-0 relative focus-within:relative focus-within:z-20",
                day_button: cn(
                    buttonVariants({ variant: "ghost" }),
                    "h-full w-full p-2 font-normal aria-selected:opacity-100 rounded-xl hover:bg-blue-50 hover:text-blue-600 transition-all flex flex-col items-center justify-center gap-1 border border-transparent hover:border-blue-100"
                ),
                selected:
                    "bg-blue-600 text-white hover:bg-blue-600 hover:text-white focus:bg-blue-600 focus:text-white shadow-md shadow-blue-200",
                today: "bg-slate-50 text-[#101D42] font-bold border-2 border-blue-100",
                outside:
